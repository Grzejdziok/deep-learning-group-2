        ...
        for pm in PM:                               #These are for the colours of different fig 3 lines
            for i in range(pm):                     #This is for how many times you need to prune and train, per fig 3 line
                ...
                for i in range(3):
                    ...
                    print(model.layers[i].weight.shape, weights_original[i].shape)
                    model.layers[i].weight = weights_original[i]
            ...
            print(f"Iterations: {total_iterations}, PM: {pm}, ACCURACY: {accuracy}")
