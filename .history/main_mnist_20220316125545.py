...
if __name__ == "__main__":
    ...
    PM = [0.8**0, 0.8**3, 0.8**7, 0.8**12, 0.8**15, 0.8**18] #P_m's from figure 3
    ...
    for pm in PM:
        for total_iterations in TOTAL_ITERATIONS:
            amount_to_prune = 0.01*pm**1/total_iterations
            while iterations_so_far < total_iterations:
                ...
                # print(list(model.layers[0].named_buffers())[0][1])
